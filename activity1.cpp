...
class Student
{
    ...
    friend int calculateTotal(Student s);  // Friend function
};
int calculateTotal(Student s) //not a member function of student
...
int main() {
    Student s(85, 90, 78, 92);
    cout << "Total Marks: " << calculateTotal(s) << endl;
    return 0;
}
